...
namespace InventoryManagement.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register()
        {
            ...
            ViewBag.role0 = roles[0].ToString();
            ViewBag.role1 = roles[1].ToString();
            ViewBag.role2 = roles[2].ToString();
            ViewBag.role3 = roles[3].ToString();
            ViewBag.role4 = roles[4].ToString();

         

            var query = _db.Clients.Select(c => new { c.Id, c.ClientName });
            ViewBag.Id = new SelectList(query.AsEnumerable(), "Id", "ClientName", 1);
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public ActionResult Register(RegisterModel model, string radiobutton1)
        {
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    {
                        Roles.AddUserToRole(model.UserName, "View");
                    }
